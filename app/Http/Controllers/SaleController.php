...
class SaleController extends Controller
{
    public function index(Request $request)
    {
        ...
        if($role->hasPermissionTo('sales-index')) {
            ...
            return view('sale.index',compact('starting_date', 'ending_date', 'warehouse_id', 'sale_status', 'payment_status', 'lims_gift_card_list', 'lims_pos_setting_data', 'lims_reward_point_setting_data', 'lims_account_list', 'lims_warehouse_list', 'all_permission'));
        }
        else
