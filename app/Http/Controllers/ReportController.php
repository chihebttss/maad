...
class ReportController extends Controller
{
    ...
    public function dailySaleObjective(Request $request)
    {
        ...
        if($role->hasPermissionTo('dso-report')) {
            ...
            return view('report.daily_sale_objective', compact('starting_date', 'ending_date'));
        }
        else
            return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
    }
    ...
    public function productExpiry()
    {
        ...
        $lims_product_data = DB::table('products')
                            ...
                            ->get();
        return view('report.product_expiry_report', compact('lims_product_data'));
    }
    ...
    public function saleReportChart(Request $request)
    {
        ...
        $start_date = $request->start_date;
        $end_date = $request->end_date;
        return view('report.sale_report_chart', compact('start_date', 'end_date', 'warehouse_id', 'time_period', 'sold_qty', 'date_points', 'lims_warehouse_list'));
    }
