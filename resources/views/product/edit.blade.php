                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="price" value="{{$lims_product_data->price}}"  class="form-control" step="any">
                                        <span class="validation-msg"></span>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <input type="hidden" name="barcode_symbology" value="{{$lims_product_data->barcode_symbology}}" >
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
