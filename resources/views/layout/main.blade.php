...
{{--                @endif--}}
            ...
            <li id="product-report-menu">
                ...
                <a id="report-link" href=""><i class="dripicons-document-remove"></i>{{trans('file.Product Report')}}</a>
                {!! Form::close() !!}
            ...
            @if($sale_report_active)
                <li id="sale-report-menu">
                    ...
                    <input type="hidden" name="end_date" value="{{date('Y-m-d')}}" />
                    <input type="hidden" name="warehouse_id" value="0" />
                    <a id="sale-report-link" href=""><i class="dripicons-document-remove"></i>{{trans('file.Sale Report')}}</a>
                    {!! Form::close() !!}
                </li>
            @endif
            <?php
            ...
            @if($purchase_report_active)
                <li id="purchase-report-menu">
                    ...
                    <input type="hidden" name="end_date" value="{{date('Y-m-d')}}" />
                    <input type="hidden" name="warehouse_id" value="0" />
                    <a id="purchase-report-link" href=""><i class="dripicons-document-remove"></i>{{trans('file.Purchase Report')}}</a>
                    {!! Form::close() !!}
                </li>
            @endif
            <?php
